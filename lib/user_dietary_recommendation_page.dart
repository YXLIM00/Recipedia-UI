...
class UserDietaryRecommendationPage extends StatefulWidget {
  const UserDietaryRecommendationPage({Key? key}) : super(key: key);

  @override
  State<UserDietaryRecommendationPage> createState() => _UserDietaryRecommendationPageState();
}

class _UserDietaryRecommendationPageState extends State<UserDietaryRecommendationPage> {
  late String userId;
